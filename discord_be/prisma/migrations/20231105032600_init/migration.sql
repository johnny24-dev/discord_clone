-- CreateEnum
CREATE TYPE "MemberRole" AS ENUM ('ADMIN', 'MODDERATOR', 'GUEST');
...
-- CreateIndex
CREATE INDEX "Member_profileId_severId_idx" ON "Member"("profileId", "severId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Conversation_memberOneId_key" ON "Conversation"("memberOneId");

-- CreateIndex
CREATE UNIQUE INDEX "Conversation_memberTwoId_key" ON "Conversation"("memberTwoId");
...
-- AddForeignKey
ALTER TABLE "Member" ADD CONSTRAINT "Member_severId_fkey" FOREIGN KEY ("severId") REFERENCES "Server"("id") ON DELETE CASCADE ON UPDATE CASCADE;
